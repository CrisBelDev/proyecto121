        ...
        panelBebidasLayout.setVerticalGroup(
            ...
            .addGroup(panelBebidasLayout.createSequentialGroup()
                ...
                .addGroup(panelBebidasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(voltext, javax.swing.GroupLayout.DEFAULT_SIZE, 35, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
...
String volumen= voltext.getText();

try {
Bebidas nuevo = new Bebidas(b,nombre,descripcion,  precio,  disponible,  estado,volumen);
r.agregarBebida(nuevo);
cargarTablaBebidas(r);
...
// ACTUALIZA LA TABLA DE BEBIDAS
private void cargarTablaBebidas(Restaurante restaurante) {
...
modelo.addRow(new Object[]{b.getNombre(), b.getPrecio()});
}
}

// ACTUALIZA LA TABLA DE POSTRES
private void cargarTablaPostres(Restaurante restaurante) {
